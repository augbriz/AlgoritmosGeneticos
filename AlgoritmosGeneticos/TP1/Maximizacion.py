...
def cromosoma_decimal(cromosoma):  #Este procedure convierte un cromosoma binario a decimal, donde va sumando el valor de cada bit multiplicado por 2 elevado a la potencia de su posición
    decimal = 0
